...
const HeaderAndHero = ({ title, desc }: HeaderAndHeroProps) => {
  return (
    <section className="bg-black px-6 w-full min-h-[50vh] md:min-h-screen flex items-center justify-center flex-col gap-8">
      ...
      <p className="text-white font-main text-5xl md:text-6xl lg:text-8xl text-center w-full uppercase">
        {title}
      </p>

      <p className="font-sub text-lg md:text-xl lg:text-2xl text-center w-full text-gray-400 tracking-widest uppercase">
        {desc}
      </p>
    </section>
  );
